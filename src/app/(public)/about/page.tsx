    ...
    return (
        <div>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center gap-20">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-[#15395B] leading-relaxed mt-3">
                                Nestled in the heart of London's Mayfair, The Royal Hotel has been a beacon of sophistication since
                                1892. Our grand architecture, impeccable service, and attention to every detail create an unforgettable
                                experience.
                                <br /><br />
                                From our Michelin-starred restaurant to our world-class spa, every moment at The Royal is designed to
                                exceed your expectations. We've hosted royalty, dignitaries, and discerning travelers from around the
                                globe.
                            </p>
                        </div>
                        {/* Image Section */}
            ...
            <section className="bg-primary-12 py-16 md:py-24">
                <Container>
                    <div className="grid grid-cols-2 bor md:grid-cols-4 gap-8 md:gap-12">
